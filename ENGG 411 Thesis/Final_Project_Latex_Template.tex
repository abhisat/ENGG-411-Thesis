...
\label{tendermintgenesis}
\lstset{%
   breaklines=true
}
The following is the code for the first block of a Tendermint consensus blockchain\cite{2018UsingDocumentation}.
\begin{lstlisting}
{
  ...
  ``validators": [
    {
      ``pub_key": [
        1,
        ``9BC5112CB9614D91CE423FA8744885126CD9D08D9FC9D1 F42E552D662BAA411E"
      ],
      ``power": 1,
      ``name": ``mach1"
    },
    {
      ``pub_key": [
        1,
        ``F46A5543D51F31660D9F59653B4F96061A740FF7433 E0DC1ECBC30BE8494DE06"
      ],
      ``power": 1,
      ``name": ``mach2"
    },
    {
      ``pub_key": [
        1,
        ``0E7B423C1635FD07C0FC3603B736D5D27953C1C6CA865B B9392CD79DE1A682BB"
      ],
      ``power": 1,
      ``name": ``mach3"
    },
    {
      ``pub_key": [
        1,
        "4F49237B9A32EB50682EDD83C48CE9CDB1D02A7CFDADCFF6E C8C1FAADB358879"
      ],
      ``power": 1,
      ``name": ``mach4"
    }
...
\label{ethereumgenesis}
The following the genesis.json code for the first block of an Ethereum blockchain\cite{BenjaminM.Brown2018HowQuickly}.
\begin{lstlisting}
{
    ``nonce": ``0xdeadbeefdeadbeef",
    ``timestamp": ``0x0",
    ``parentHash": ``0x00000000000000000000000000000000000 00000000000000000000000000000",
    ``extraData": ``0x0",
    ``gasLimit": ``0x8000000",
    ``difficulty": ``0x400",
    ``mixhash": ``0x0000000000000000000000000000000000000 000000000000000000000000000",
...
\label{ganttchart}
The following is the Gantt chart for the project.
\includepdf[]{gantt_chart.pdf}
